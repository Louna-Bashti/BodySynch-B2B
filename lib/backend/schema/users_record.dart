...
class UsersRecord extends FirestoreRecord {
  ...
  // "listUsersConnected" field.
  List<String>? _listUsersConnected;
  List<String> get listUsersConnected => _listUsersConnected ?? const [];
  bool hasListUsersConnected() => _listUsersConnected != null;
  ...
  void _initializeFields() {
    ...
    _listUsersConnected = getDataList(snapshotData['listUsersConnected']);
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.title == e2?.title &&
        listEquality.equals(e1?.listUsersConnected, e2?.listUsersConnected);
  }
